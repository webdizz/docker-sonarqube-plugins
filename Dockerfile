...
RUN cd /opt/sonar/extensions/plugins && \
    ...
    http://repo1.maven.org/maven2/org/codehaus/sonar-plugins/sonar-ldap-plugin/${LDAP_PLUGIN_VERSION}/sonar-ldap-plugin-${LDAP_PLUGIN_VERSION}.jar
...
RUN cd /opt/sonar/extensions/plugins && \
    ...
    http://repo1.maven.org/maven2/org/codehaus/sonar-plugins/sonar-build-breaker-plugin/${BUILD_BREAKER_PLUGIN_VERSION}/sonar-build-breaker-plugin-${BUILD_BREAKER_PLUGIN_VERSION}.jar
